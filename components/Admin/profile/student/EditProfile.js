...
import style from "./../../../../pages/admin/admission/student-admission"
				...
				<div className="form-group row">
					...
					<div className="col-sm-8 col-md-6 my-2 position-relative">
						...
						>
							...
							{religion.map((rel) => {
								return <option className={`form-control`}>{rel.name}</option>
							})}
						</select>
						<FontAwesomeIcon
							className={style.selectDownArrow}
					...
					<div className="col-sm-8 col-md-6 my-2 position-relative">
						...
						>
							{religion[castInd].castes.map((cast) => {
								return <option className={`form-control`}>{cast.name}</option>
							})}
						</select>
						<FontAwesomeIcon
							className={style.selectDownArrow}
